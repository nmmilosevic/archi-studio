      ...
      {LOCALES.map((loc, index) => (
        <span key={loc.code} className="flex items-center">
          <button
            ...
            className={clsx(
              "font-body text-[14px] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bronze focus-visible:ring-offset-2 cursor-pointer",
              locale === loc.code
                ? light
