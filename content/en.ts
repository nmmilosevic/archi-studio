const en = {
  ...
  contact: {
    ...
    sub: "Send the current studio website and the first-impression problem you want to solve. I will reply within 24 hours.",
    ...
    form: {
      ...
      cta: "Send message",
      success: "Message received. I will be in touch within 24 hours.",
    },
  },
  faq: [
