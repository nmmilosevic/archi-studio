const es = {
  ...
  hero: {
    label: "Estudio digital para arquitectura y diseño de interiores",
    headline: "Tu trabajo ya es premium. Tu web debería serlo también.",
    sub: "FORMA COSTA crea webs refinadas, sistemas de portafolio y estrategias de SEO local para estudios de arquitectura y diseño de interiores en la Costa del Sol.",
    ctaPrimary: "Solicitar auditoría web",
  ...
  method: {
    label: "El proceso",
    heading: "Seis pasos. Sin sorpresas.",
    steps: [
      { number: "01", title: "Auditoría", desc: "Revisamos la web actual, el posicionamiento, la experiencia móvil, la presentación de proyectos y la visibilidad en búsquedas locales." },
      { number: "02", title: "Dirección", desc: "Definimos la dirección visual, la estructura de contenido, las páginas, las prioridades SEO y el camino de conversión." },
      { number: "03", title: "Diseño", desc: "Creamos un sistema de interfaz refinado con tipografía sólida, jerarquía de imágenes, narrativa de proyectos y layouts responsivos." },
      { number: "04", title: "Construcción", desc: "Construimos una web rápida con código limpio, estructura multilingüe si es necesario, SEO técnico, analítica y despliegue en Vercel." },
  ...
  audit: {
    ...
    form: {
      ...
      consent: "Acepto ser contactado sobre mi solicitud de auditoría.",
      cta: "Solicitar mi auditoría",
      success: "Gracias. Revisaré tu web y me pondré en contacto en un plazo de 48 horas.",
    },
    faq: [
      { q: "¿La auditoría es realmente gratuita?", a: "La auditoría inicial y las recomendaciones escritas están incluidas. Si quieres una vista previa completa del rediseño o la implementación, eso pasa a ser un proyecto de pago." },
  ...
  contact: {
    ...
    sub: "Cuéntanos sobre tu estudio y qué quieres mejorar. Te responderemos en 24 horas.",
    ...
    response: "Respuesta habitual en 24 horas. Para proyectos urgentes, menciónalo en tu mensaje.",
    form: {
      name: "Tu nombre",
      email: "Dirección de email",
      studio: "Nombre del estudio",
      ...
      typeOptions: ["Rediseño web", "Web nueva", "SEO local", "Alojamiento y mantenimiento", "Sistema de portafolio", "Refinamiento de marca", "Aún no lo sé"],
      budget: "Rango de presupuesto",
      budgetOptions: ["Menos de €750", "€750 a €1.500", "€1.500 a €3.500", "€3.500+", "Solo atención mensual"],
      message: "Cuéntanos sobre tu estudio y tus objetivos",
      cta: "Enviar mensaje",
