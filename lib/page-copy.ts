...
const PAGE_COPY = {
  en: {
    ...
    work: {
      ...
      projectsHeading: "Selected website redesign studies",
      gridAria: "Work grid",
    ...
    metadata: {
      ...
      servicesTitle: "Architecture studio website services",
      ...
      workTitle: "Architecture studio website projects",
      workDescription: "Website redesign studies for architecture and interior studios, with clearer project portfolios, stronger positioning, and refined mobile presentation.",
  ...
  es: {
    ...
    work: {
      ...
      projectsHeading: "Estudios de rediseño web seleccionados",
    ...
    metadata: {
      ...
      servicesTitle: "Diseño web para estudios de arquitectura",
      ...
      workTitle: "Proyectos web de estudios de arquitectura",
      workDescription: "Estudios de rediseño web para arquitectura e interiorismo, con proyectos mejor estructurados, posicionamiento claro y presentación móvil cuidada.",
  ...
  fr: {
    ...
    work: {
      ...
      projectsHeading: "Études de refonte de site sélectionnées",
    ...
    metadata: {
      ...
      servicesDescription: "Refonte de site, portfolio, visibilité organique, hébergement et raffinement de marque pour studios d’architecture, d’intérieur et de paysage.",
      workTitle: "Projets web de studios d'architecture",
      workDescription: "Études de refonte pour studios d'architecture et d'intérieur, avec projets mieux structurés, positionnement clair et présentation mobile soignée.",
